    ...
    <UserLayout>
      <div className="max-w-4xl mx-auto p-8 font-sans">
        ...
        <div className="space-y-6 flex flex-col">
          ...
          <div className="w-full md:w-96 h-64 mt-4 rounded-lg overflow-hidden">
            <Maps
        ...
        {isEditing && (
          <div className="flex justify-center mt-4">
            <button
              ...
              className="px-6 py-2 bg-purple-600 text-white rounded-xl shadow-md hover:bg-purple-700 focus:outline-none focus:ring-4 focus:ring-purple-300 transition duration-200"
            >
              {isLoading ? (
                <ClipLoader color="#fff" loading={isLoading} size={24} />
              ) : (
