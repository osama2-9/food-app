...
export const MealPage: React.FC = () => {
  ...
  const isOfferActive = meal && new Date() < new Date(meal.offerValidity);

  const formatOfferValidity = (date: string) => {
          ...
          {meal && (
            <>
              ...
              <div className="bg-white p-6 rounded-lg shadow-xl space-y-4">
                ...
                {meal.isOffer && isOfferActive && (
                  <div className="flex flex-col ">
                    <div className=" bg-red-600 w-28 text-center text-white px-3 py-1 text-xs rounded-full">
                      Special Offer
                    </div>
                    <p className="mt-2 text-sm text-gray-600">
                      Valid until: {formatOfferValidity(meal.offerValidity)}
                    </p>
                  </div>
                )}
